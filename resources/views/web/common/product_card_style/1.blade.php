    ...
    <article>
        <div class="thumb">
            ...
            <div class="product-hover d-none d-lg-block d-xl-block">
                <div class="icons">
                    ...
                    <a class="icon active swipe-to-top is_liked" products_id="<?php echo $products->products_id ?>" data-toggle="tooltip" data-placement="bottom" title="@lang('website.Wishlist')">
                        <i class="fas fa-heart"></i>
                    </a>

                    <?php /* <div class="icon swipe-to-top modal_show " products_id ="{{$products->products_id}}" data-toggle="tooltip" data-placement="bottom" title="@lang('website.Quick View')">
                ...
                @endif
                @elseif($products->products_type==1 || $products->products_type==3)
                <a class="btn btn-block  btn-secondary swipe-to-top" href="{{ URL::to('/product-detail/'.$products->products_slug)}}" data-toggle="tooltip" data-placement="bottom" title="@lang('website.View Detail')">@lang('website.View Detail')</a>
            ...
            <div class="mobile-icons d-lg-none d-xl-none">
                <div class="icons">
                    <div class="icon-liked">
                        ...
                        <a class="icon active swipe-to-top is_liked" products_id="<?php echo $products->products_id ?>">
                            <i class="fas fa-heart"></i>
                        </a>
        ...
        <div class="content">
            ...
            <div class="expand-detail">
                <?php echo stripslashes($products->products_description) ?>
            </div>
            <div class="price">
                @if(!empty($products->discount_price))
