            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-9 ">
                    ...
                    <form name="updateMyProfile" class="align-items-center" enctype="multipart/form-data" action="{{ URL::to('updateMyProfile')}}" method="post">
                        ...
                        @php $country_code = '+20';
                        if(auth()->guard('customer')->user()->country_code){
                        $country_code=auth()->guard('customer')->user()->country_code;
                        }
                        @endphp
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label">@lang('website.Country Code')</label>
                            <div class="from-group  select-control col-sm-4 ">
                                <select class="form-control" name="customers_country_code">
