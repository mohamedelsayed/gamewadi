...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> {{ trans('labels.digitalInventory') }} <small>{{ trans('labels.digitalInventory') }}...</small> </h1>
        <ol class="breadcrumb">
            ...
            @endif
            <li class="active">{{ trans('labels.digitalInventory') }}</li>
        </ol>
    </section>
    <!-- Main content -->
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="box box-info">
                                                            <div class="box-header with-border">
                                                                <h3 class="box-title">{{ trans('labels.Stock') }}</h3>
                                                            ...
                                                            <!-- /.box-header -->
                                                            <div class="box-body">
                                                                {!! Form::open(array('url' =>'admin/products/inventory/addnewstock',
                                                                'name'=>'inventoryfrom',
                                                                'id'=>'addewinventoryfrom', 'method'=>'post', 'class' => 'form-horizontal form-validate',
                                                                'enctype'=>'multipart/form-data')) !!}
                                                                <div class="form-group">
                                                                    <label for="products_id" class="col-sm-2 col-md-4 control-label">{{ trans('labels.Product') }}<span style="color:red;">*</span> </label>
                                                                    <div class="col-sm-10 col-md-8">
                                                                        <select class="form-control field-validate product-digital-inventory" name="products_id">
                                                                            <option disabled selected value="">{{ trans('labels.Choose Product') }}</option>
                                                                ...
                                                                <div class="form-group" id="countryWrapper" style="display: none;">
                                                                    <label for="country_id" class="col-sm-2 col-md-4 control-label">{{ trans('labels.Country') }}<span style="color:red;">*</span> </label>
                                                                    <div class="col-sm-10 col-md-8">
                                                                        <select class="form-control field-validate product-digital-country" name="country_id" id="countriesSelect" onchange="showDenominationsByCountry(this);" > </select>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="box box-danger">
                                                            ...
                                                            <!-- /.box-header -->
                                                            <div class="box-body">
                                                                {!! Form::open(array('url' =>'admin/products/inventory/addminmax', 'name'=>'addminmax',
                                                                'id'=>'addminmax', 'method'=>'post', 'class' => 'form-horizontal form-validate-level',
                                                                'enctype'=>'multipart/form-data')) !!}
