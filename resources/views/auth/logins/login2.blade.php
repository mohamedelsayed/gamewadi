                            ...
                            <div class="registration-process">
                                <form name="signup" enctype="multipart/form-data"  action="{{ URL::to('/signupProcess')}}" method="post">
                                    ...
                                    <div class="from-group mb-3">
                                        ...
                                        <div class="input-group col-12">
                                            <input required name="firstName" type="text" class="form-control field-validate" id="firstName" placeholder="@lang('website.Please enter your first name')" value="{{ old('firstName') }}">
                                    ...
                                    <div class="from-group mb-3">
                                        ...
                                        <div class="input-group col-12">
                                            <input required name="lastName" type="text" class="form-control field-validate field-validate" id="lastName" placeholder="@lang('website.Please enter your first name')" value="{{ old('lastName') }}">
                                    ...
                                    <div class="from-group mb-3">
                                        ...
                                        <div class="input-group col-12">
                                            <input required name="email" type="text" class="form-control" id="inlineFormInputGroup" placeholder="Enter Your Email or Username" value="{{ old('email') }}">
                                            <span class="help-block" hidden>@lang('website.Please enter your valid email address')</span>
                                        </div>
                                    </div>
                                    <div class="from-group mb-3">
                                        ...
                                        <div class="input-group col-12">
                                            <input required name="password" id="password" type="password" class="form-control"  placeholder="@lang('website.Please enter your password')">
                                    ...
                                    <div class="from-group mb-3">
                                        ...
                                        <div class="input-group col-12">
                                            <input required type="password" class="form-control" id="re_password" name="re_password" placeholder="Enter Your Password">
                                    ...
                                    @php $country_code = '+20'; @endphp
                                    <div class="from-group mb-3">
                                        <div class="col-12" > <label for="inlineFormInputGroup"><strong  style="color: red;">*</strong>@lang('website.Country Code')</label></div>
                                        <div class="input-group col-12">
                                            <select class="form-control field-validate" name="customers_country_code">
                                                @foreach($phoneCodes as $country => $code)
                                                <option value="{{$code}}" @if($country_code == $code) selected @endif>{{$country}} ({{$code}})</option>
                                                @endforeach
                                            </select>
                                            <span class="help-block" hidden>@lang('website.Please select your Country Code')</span>
                                        </div>
                                    </div>
                                    <div class="from-group mb-3">
                                        <div class="col-12"> <label for="inlineFormInputGroup"><strong style="color: red;">*</strong>@lang('website.Mobile')</label></div>
                                        <div class="input-group col-12">
                                            <input required name="customers_telephone" type="text" class="form-control" id="inlineFormInputGroup" placeholder="Enter Your Mobile" value="{{ old('customers_telephone') }}">
                                            <span class="help-block" hidden>@lang('website.Please enter your valid Mobile')</span>
                                        </div>
                                    </div>
                                    <div class="from-group mb-3">
                                        <div class="input-group col-12">
